...
Clear, misshappen spores were observed in *Campyloneurum* sp1, whereas *C. angustifolium* is a sexual diploid (2*n* = 72) with oblong spores [@Leon1992].
...
**`r s_table_full("genbank")`** All specimens from the Nectandra Cloud Forest Reserve, Alajuela Province, Costa Rica, except for *Abrodictyum rigidum* (Sw.) Ebihara & Dubuisson (*J.-Y. Dubuisson HV 1997-3*, Venezuela), *Radiovittaria remota* (Fée) E.H. Crane (*R. Moran 3180a*, Costa Rica), and *Trichomanes polypodiodes* L. (*M. Kessler 8808*, Bolivia).
