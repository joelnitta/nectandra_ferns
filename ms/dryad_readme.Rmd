...
GenBank in FASTA format. Sequences aligned using MAFFT [@Katoh2002]. Species
from Nectandra in family Dicksoniaceae included as outgroup. Numbers after
...
on GenBank in Newick format. Tree inferred using FastTree [@Price2009;
@Price2010] and rooted on species from Nectandra in family Dicksoniaceae.
...
sequences on GenBank in Newick format. Tree inferred using FastTree
[@Price2009; @Price2010] and rooted on species from Nectandra in subfamily
Polypodioideae. Numbers after species names are GenBank accession numbers for
sequences downloaded from GenBank or J. H. Nitta specimen collection numbers
