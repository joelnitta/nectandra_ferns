...
Code to replicate all analyses, figures, and this manuscript are available at https://github.com/joelnitta/nectandra_ferns. Data are available from the Dryad repository at http://doi.org/ADD_DOI_HERE_WHEN_ASSIGNED. Newly generated sequences have been deposited in GenBank (ADD NUMBERS). Photos of voucher specimens available at https://www.fernsoftheworld.com/florulas/ADD_URL_HERE_WHEN_ASSIGNED.

\*\*\*NOTE FOR EDITOR AND REVIEWERS: data and code will be made publicly available upon acceptance. During review, data and code can be downloaded from the following link ADD_URL_HERE_WHEN_READY.\*\*\*
