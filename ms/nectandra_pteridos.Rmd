...
We downloaded *rbcL* sequences from GenBank if available for any taxa that could not be successfully sequenced (`r s_table("genbank")`).
...
Sampling of multiple specimens per species for taxa that are morphologically difficult to distinguish revealed several non-monophyletic species, indicative of species complexes.
