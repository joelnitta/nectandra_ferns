...
We carried out surveys of pteridophytes over three field seasons (January 2008, 2011, and 2013; `r specimens %>% filter(!is.na(date_collected)) %>% pull(date_collected) %>% n_distinct` days of sampling total). Most specimens were collected along trails through the reserve. Epiphytes were collected from fallen trees or tree branches, or up to \circa \SI{2}{\meter} on tree trunks. Voucher specimens are deposited at UC and CR. Leaf tissue was preserved on silica gel for DNA extraction. A permit for collection was issued by MINAET (ADD NUMBER). We observed spores of selected taxa with a standard compound light microscope.
