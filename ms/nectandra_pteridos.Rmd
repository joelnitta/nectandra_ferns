...
We assessed the utility of *rbcL* for species identification by calculating interspecific distances. Species sharing identical *rbcL* sequences with at least one other species (interspecific distance of zero) were considered failures, \ie not possible to identify with this marker. We treated subspecific taxa as distinct species for this purpose.
...
```{r richness-inext, fig.height=2.5, fig.width=2.5, fig.cap="Interpolation and extrapolation of species richness. Point indicates observed richness."}
...
ggplot(min_distance_table, aes(range, percent, fill = is_zero)) +
  geom_col() +
