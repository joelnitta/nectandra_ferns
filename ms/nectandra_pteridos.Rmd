...
We characterized the taxonomic and phylogenetic diversity of pteridophytes (ferns and lycophytes) of the Nectandra Cloud Forest Reserve, Costa Rica. We carried out surveys over three field seasons (2008, 2011, and 2013). We documented `r taxa_count %>% pull(species)` species, representing `r taxa_count %>% pull(genus)` genera and `r taxa_count %>% pull(family)` families of pteridophytes. Three taxa appear to be previously undescribed hybrids. We sequenced plastid *rbcL* and tested the utility of this gene for identifying species by calculating minimum interspecific distances. We compared the pteridophyte flora at Nectandra with other sites in Costa Rica. We find that Nectandra has an exceptionally rich pteridophyte flora for its area.
