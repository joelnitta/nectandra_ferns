...
*Sphaeropteris brunei* (H. Christ) R.M. Tryon is nested within *Cyathea* (SH-aLRT 93%; UFboot 95%). These were resolved in their expected genera in broadly sampled trees using all available *rbcL* sequences on GenBank (results not shown), so irregular placement here appears to be due to low sampling rather than poor sequence quality or misidentification.
