...
**`r figure_full("map")`** (a) Map of Costa Rica, showing location of Nectandra (yellow diamond) and other protected areas that have been surveyed for pteridophytes.
...
Our literature survey identified five other protected areas in mainland Costa Rica that have been surveyed for pteridophytes [@Bigelow1991; @oet2019; @Kappelle2000; @Rojas2008; @Jimenez2016] (`r figure("map")`).
...
# \\textsuperscript{a}
 ...
 #    area_ha = "Area (ha)",
 #    richness = "Richness (no. spp.)",
 #    richness_per_ha = "Richness per area (no. spp. per ha)",
 #    holdridge_type = "Life zone type(a)",
 #    citation = "Reference"
 #  ) %>%
 #  fmt_number(
 #    columns = vars(area_ha, richness, richness_per_ha),
...
^a^Life zones follow scheme of @Holdridge1967.
