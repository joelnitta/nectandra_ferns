...
Joel H. Nitta^1^*, Atsushi Ebihara^2^, Freddy Castillo^3^, and Alan R. Smith^4^
...
^3^Nectandra Institute, San Ramon, Costa Rica

^4^The University Herbarium, University of California, Berkeley, Berkeley, California, United States of America
...
# Be sure to check references numbers to make sure they match final version!
cr_richness %>%
